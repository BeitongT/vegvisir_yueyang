...
class UserPanelActivity : AppCompatActivity() {
    ...
    private var S:strategy=strategy.ThingsList
    ...
    fun viewRecordsButtonListener(view: View) {
        ...
        when(S) {
            strategy.BlockchainBrowser->
                intent = Intent(this, BlockChainBrowserActivity::class.java)
            strategy.ThingsList->
                intent = Intent(this, ThingsBrowserActivity::class.java)
        }
        startActivity(intent)
    }
    ...
    fun addBlockButtonListener(view: View) {
        ...
        when(S) {
            strategy.BlockchainBrowser->
                intent = Intent(this, AddBlockActivity::class.java)
            strategy.ThingsList->
                //intent = Intent(this, AddBlockActivity::class.java)
                intent = Intent(this, ThingsActivity::class.java)
        }
        intent.putExtra("UserPassword", userPassword!!)
        startActivity(intent)
    }
