            ...
            while (true) {
                try {
                    ...
                    when (parsedMessage.type) {
                        ...
                        ProtocolMessageProto.ProtocolMessage.MessageType.GET_STREAM->
                            mergeRemoteBlockChainProtocol.streamChannel.put(byteStream.recvStream())
                        ProtocolMessageProto.ProtocolMessage.MessageType.GET_FILE->
                            mergeRemoteBlockChainProtocol.streamChannel.put(byteStream.recvFile().inputStream())
